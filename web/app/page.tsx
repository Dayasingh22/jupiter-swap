...
export default function Swap() {
  ...
  async function signAndSendTransaction() {
    ...
    const merchantUSDCTokenAccount = await getMerchantUSDCTokenAccount(
  ...
  async function getMerchantUSDCTokenAccount(merchantWalletPublicKey: any) {
    return await getAssociatedTokenAddress(USDC_MINT, merchantWalletPublicKey);
  }
